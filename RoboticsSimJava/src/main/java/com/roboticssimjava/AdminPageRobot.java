...
public class AdminPageRobot {
    ...
    public void initialize() {
        ...
        data.addAll(new LoginPageController().createArraylistImgRobot());
    ...
    public void chooseRobotImage(ActionEvent actionEvent) throws MalformedURLException {
        FileChooser fileChooser = new FileChooser();
        configureFileChooser(fileChooser);
        File file = fileChooser.showOpenDialog(new Stage());
        if (file != null) {
            dbImage image = new dbImage();
            image.addImageRobot(file);
            reloadWindow();
        }
    }
    ...
    public void deleteRobotsImage(ActionEvent event) {
        ...
        String sql = "DELETE FROM datafile.imagesRobot WHERE id = ?";
    ...
    private void updatePhotoData(int id, boolean newValue) {
        ...
        DatabaseConnection connectNow = new DatabaseConnection();
        Connection connection = connectNow.getDatabaseLink();
        String sql = "UPDATE datafile.imagesRobot SET useIT = ? WHERE id = ?";
        try (PreparedStatement statement = connection.prepareStatement(sql)) {
